...
<table border=1 >
    ...
    <?php     
        include("db.php");
	$result=mysql_query("SELECT * FROM mrh_carga where cedulaempleado=$cedulaempleado");
    ...
    <tr>
        <td>    
            <td><a href ='carga.php?codigo=<?php echo $cedulaempleado?>'><input type="button" value="Atras"></a></td>
        </td>
    </tr>
<p></p>
                                </div>
