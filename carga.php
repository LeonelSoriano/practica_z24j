...
<table> 
        <tr>    
            ...
            <td><a href ='carga_ver.php?codigo=<?php echo $cedulaempleado?>'><input type="button" value="Ver Carga"></a></td>
...
if (isset($_POST['submit']))
	{	   
            ...
            values ('$cedulaempleado','$cedula','$primernombre','$segundonombre','$primerapellido',
                    '$segundoapellido','$fechanacimiento','$parentesco','$estudios')";
            //echo $sql;
            //exit;
