                        ...
                        <div class="dynamicContent" align="left">
                            ...
                            <TABLE BORDER="0" CELLSPACING="4" WIDTH="500">
                                ...
                                <TR>
                                    ...
                                    <td>
                                        <p>
                                            Crédito    <input type="radio"  name="tipo_cobro" value="credito"/>
                                                &nbsp;&nbsp;&nbsp;
                                            Al Contado    <input type="radio" name="tipo_cobro" value="al_contado"/>
                                        </p>
                                    </td>
                                </TR>
                                ...
                                <TR>
                                    ...
                                    <TD><p><input type="text" name="fletes" size="20"></p></TD>
                                </TR>

                                <TR>
                                    <TD><label>Monto Factura</label></TD>
                                    <TD><p><input type="text" name="monto_factura" size="20"></p></TD>
                                </TR>
                                ...
                                <tr>
                                    ...
                                    <td><p><input type="text"  disabled/></p></td>
                                </tr>
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <a href="compras_ver.php"><input type="button" value="Ver datos"></a>
                                    </td>
                                    <td>
